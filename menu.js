document.addEventListener("DOMContentLoaded", () => {
    ...
    <aside id="sidebar" class="w-64 md:w-56 bg-primary text-white flex flex-col fixed inset-y-0 left-0 z-50 transform -translate-x-full md:translate-x-0 md:relative transition-transform duration-300 shadow-2xl md:shadow-xl">
        ...
        <nav class="flex-1 p-2 space-y-1 overflow-y-auto custom-scroll pb-6">
            <a href="admin_dashboard.html" class="flex items-center p-2 rounded-md transition text-sm ${currentPage === 'admin_dashboard.html' ? 'bg-secondary text-white font-bold shadow-md' : 'text-gray-300 hover:bg-white/10'}"><i class="fa-solid fa-chart-pie mr-3 w-4"></i> Dashboard</a>
            ...
            <div class="space-y-1 pt-1">
                ...
                <div id="submenu-ven" class="pl-8 space-y-0.5 mt-1 ${currentPage.includes('admin_ventas') ? '' : 'hidden'}">
                    <a href="admin_ventas.html" class="block py-1.5 text-xs ${currentPage === 'admin_ventas.html' ? 'text-secondary font-bold' : 'text-gray-400 hover:text-white'}">Terminal POS</a>
                    <a href="admin_ventas_parametros.html" class="block py-1.5 text-xs ${currentPage === 'admin_ventas_parametros.html' ? 'text-secondary font-bold' : 'text-gray-400 hover:text-white'}">Parámetros</a>
                </div>
            </div>
            ...
            <div class="space-y-1 pt-1">
                ...
                <div id="submenu-inv" class="pl-8 space-y-0.5 mt-1 ${currentPage.includes('admin_productos') ? '' : 'hidden'}">
                    <a href="admin_productos.html" class="block py-1.5 text-xs ${currentPage === 'admin_productos.html' ? 'text-secondary font-bold' : 'text-gray-400 hover:text-white'}">Productos</a>
                    <a href="admin_productos_parametros.html" class="block py-1.5 text-xs ${currentPage === 'admin_productos_parametros.html' ? 'text-secondary font-bold' : 'text-gray-400 hover:text-white'}">Parámetros</a>
                </div>
            </div>
            ...
            <div class="space-y-1 pt-1">
                ...
                <div id="submenu-dir" class="pl-8 space-y-0.5 mt-1 ${currentPage.includes('admin_contactos') ? '' : 'hidden'}">
                    <a href="admin_contactos.html" class="block py-1.5 text-xs ${currentPage === 'admin_contactos.html' ? 'text-secondary font-bold' : 'text-gray-400 hover:text-white'}">Contactos</a>
                    <a href="admin_contactos_parametros.html" class="block py-1.5 text-xs ${currentPage === 'admin_contactos_parametros.html' ? 'text-secondary font-bold' : 'text-gray-400 hover:text-white'}">Parámetros</a>
                </div>
            </div>

            <a href="admin_configuracion.html" class="flex items-center p-2 rounded-md transition text-sm ${currentPage === 'admin_configuracion.html' ? 'bg-secondary text-white font-bold shadow-md' : 'text-gray-300 hover:bg-white/10'}"><i class="fa-solid fa-gear mr-3 w-4"></i> Configuración</a>
        </nav>
